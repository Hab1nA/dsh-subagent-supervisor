    ...
    function ChildRow(props) {
      ...
      return React.createElement('div', {
        ...
        React.createElement('div', { style: styles.meta },
          React.createElement('span', { style: styles.tag }, `模型: ${settings.model || '继承'}`),
          React.createElement('span', { style: styles.tag }, `推理: ${settings.reasoningEffort || '继承'}`),
            ...
            selectedChild === undefined
              ...
              : [
                  React.createElement('div', { key: 'head', style: styles.detailHead },
                    ...
                    selectedConfig
                      ? React.createElement('div', { style: styles.meta },
                          React.createElement('span', { style: styles.tag }, `模型: ${selectedConfig.settings ? selectedConfig.settings.model || '继承' : '继承'}`),
                          React.createElement('span', { style: styles.tag }, `推理: ${selectedConfig.settings ? selectedConfig.settings.reasoningEffort || '继承' : '继承'}`),
